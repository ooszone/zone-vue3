var __tea_iife_export__ = function(e) {
	...
	var T = function(e) {
		...
		var i, n, r = function(e) {
			...
			return t.href = e,
				t
		}, o = window.screen.width, s = window.screen.height, a = window.navigator.appVersion, c = window.navigator.userAgent, u = window.navigator.language, l = document.referrer, d = l ? r(l).hostname : "", p = function(e) {
			var t = r(e).search;
			t = t.slice(1);
			var i = {};
	...
	var Oe, xe = function() {
		...
		return function(e, t, i, n, r) {
			...
			t.channel_domain || t.disable_sdk_monitor || (this.monitor = new re),
